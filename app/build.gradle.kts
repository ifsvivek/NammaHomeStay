...
// Release signing config is read from <root>/keystore.properties (gitignored).
// If that file is absent (e.g. on a fresh clone / CI without secrets), the
...
android {
    namespace = "com.ifsvivek.nammahomestay"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
